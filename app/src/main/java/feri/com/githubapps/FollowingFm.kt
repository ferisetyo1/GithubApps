...
import kotlinx.android.synthetic.main.fragment_following_fm.*
...
class FollowingFm : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_following_fm, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        AndroidNetworking.get("https://api.github.com/users/{username}/following")
            ...
            .build()
            .getAsObjectList(ModelUserGeneral::class.java,object :
                ParsedRequestListener<List<ModelUserGeneral>> {
                override fun onResponse(response: List<ModelUserGeneral>?) {
                    rv_following.adapter=AdapterUserV2(requireContext(),response)
                }
