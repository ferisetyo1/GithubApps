...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val TYPE_REPEATING = "GithubApps Reminder"
        const val EXTRA_MESSAGE = "Peringatan harian pukul 09:00"
    ...
    private fun showAlarmNotification(context: Context, title: String, message: String, notifId: Int) {
        ...
        val CHANNEL_ID = "GhitubApp_Alrm"
        val CHANNEL_NAME = "GithubApp channel"
