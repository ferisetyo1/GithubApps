...
class AdapterUser(val ctx: Context, val list: List<ResponSearchModel.ItemsItem?>?) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.lyt.setOnClickListener { ctx.startActivity(Intent(ctx, DetailUser::class.java).putExtra("nama",item?.login)) }
